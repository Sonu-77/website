  ...
  return (
    <section id="about" className="relative py-28">
      <div className="mx-auto max-w-wrap px-5">
        <SectionHeading eyebrow="About" title="Building Digital Products That Perform" />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="mt-10 grid grid-cols-2 gap-6 sm:grid-cols-4">
              {aboutStats.map((s) => (
                <div key={s.label}>
                  ...
                  <p className="mt-1 text-xs leading-snug text-ink-2">{s.label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div data-shared-anchor="about" className="absolute -left-72 top-8 h-1 w-1" aria-hidden />
          </div>
        </div>
      </div>
    </section>
